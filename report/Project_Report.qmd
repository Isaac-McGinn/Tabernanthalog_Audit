...
```
::: {layout-ncol=2}
    ![Original Published Figure 4e (Cameron et al.,
     2021)](./published_figure_4e.png){width=100%}
   
    ```{r show-replication, echo=FALSE, fig.width=5, fig.height=5}
    # Render our replicated version of Figure 4e
